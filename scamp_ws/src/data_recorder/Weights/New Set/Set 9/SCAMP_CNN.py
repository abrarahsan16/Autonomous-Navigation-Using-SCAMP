...
history=model.fit_generator(train_generator,steps_per_epoch=int(train_generator.samples/b_size), validation_data=val_generator,validation_steps=int(val_generator.samples/b_size), max_queue_size=10, epochs=15, verbose=1, callbacks = [callbacks], workers=5)
